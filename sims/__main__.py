...
LABS = [
    ...
    ("05", "05_spectrum_lab", "مطياف غاما: معايرة + تحديد نويدات + MDA"),
    ("06", "06_neutron_diffusion", "انتشار النيوترونات والحرجية (مجموعتان) — أوجد السماكة الحرجة"),
    ("07", "07_monte_carlo_transport", "مونتي-كارلو لنقل النيوترونات (1-D) — النفاذ والارتداد والامتصاص"),
    ("08", "08_xenon_poisoning", "تسمّم الزينون وحفرة اليود — احسب نافذة إعادة التشغيل"),
]
