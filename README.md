...
![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white) ![Repo Size](https://img.shields.io/github/repo-size/hishamalmushrea-cloud/nuclear?style=for-the-badge) ![Issues](https://img.shields.io/github/issues/hishamalmushrea-cloud/nuclear?style=for-the-badge) ![Last Commit](https://img.shields.io/github/last-commit/hishamalmushrea-cloud/nuclear?style=for-the-badge) [![License](https://img.shields.io/github/license/hishamalmushrea-cloud/nuclear?style=for-the-badge)](https://github.com/hishamalmushrea-cloud/nuclear/blob/main/LICENSE)

## 📖 About this Project
Welcome to the nuclear repository!
...
0. 🚀 **الدرس الأول فعلياً:** `python3 tools/tutor.py` (أو `lessons/000-where-do-we-start.md`)
   ثم `020` (مقدمة الفيزياء النووية) ← `021` (الكتلة والربط) ← `022` (التحلل وعمر النصف).
...
lessons/     الدروس الرسمية (55 عقدة مغطّاة: 11 مؤلَّفة + 44 مولّدة)؛ كل درس اختبار مدمج
...
python3 -m sims                 # 7 مختبرات: اضمحلال · غايغر · تدريع · حركية مفاعل · طيف غاما
                                # · انتشار النيوترونات والحرجية · مونتي-كارلو للنقل · تسمّم الزينون
...
python3 tools/progress.py gate       # 🚦 بوابة المرحلة التالية (X.9: 80/70/80/75)
...
python3 tools/selftest.py         # 🧪 حزام الأمان: 13 فحصاً (رسم · دروس · مولّد · SM-2 · بوابات · مونتي-كارلو · زينون · أدوات)
```
