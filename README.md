...
lessons/     الدروس الرسمية (55 عقدة مغطّاة: 10 مؤلَّفة + 45 مولّدة)؛ كل درس اختبار مدمج
...
python3 -m sims                 # 7 مختبرات: اضمحلال · غايغر · تدريع · حركية مفاعل · طيف غاما
                                # · انتشار النيوترونات والحرجية · مونتي-كارلو للنقل
...
python3 tools/selftest.py         # 🧪 حزام الأمان: 11 فحصاً (رسم · دروس · مولّد · SM-2 · بوابات · فيزياء · أدوات)
```
