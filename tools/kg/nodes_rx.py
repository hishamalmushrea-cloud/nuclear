...
N("fuel.separation", "نظرية فصل النظائر والشغل الفصلي (SWU)", "Isotope separation theory & separative work",
  "fuel", 5, "supporting", 4, 30,
  prereqs=["chem.isotope", "phys.thermo", "math.calc1"],
  concepts=["دالة القيمة V(x) وشرط استقلال قدرة الفصل عن التركيز",
            "الشغل الفصلي SWU وخطّية ميزان «القيمة» (استقلاله عن التقنية)",
            "الشلال المثالي: عدم خلط تيارات بمختلف التراكيز وقدرة الفصل لكل مرحلة",
            "الحد الأدنى الديناميكي الحراري للفصل (إنتروبيا الخلط) ومفارقة الكفاءة ~10⁻⁸",
            "مفاضلة نسبة المخلف: سعر اللقيم مقابل سعر الشغل"],
  eqs=["V(x) = (2x−1)·ln(x/(1−x))",
       "V''(x) = 1/[x²(1−x)²]",
       "SWU = P·V(x_p) + W·V(x_w) − F·V(x_f)",
       "F/P = (x_p−x_w)/(x_f−x_w)   ,   W/P = (x_p−x_f)/(x_f−x_w)",
       "δU = F·g²/8   (قدرة عنصر فصل واحد، مستقلة عن التركيز لأدنى رتبة)",
       "W_min = R·T·[P·h(x_p) + W·h(x_w) − F·h(x_f)]  ,  h(x)=x·ln x+(1−x)·ln(1−x)"],
  apps=["اقتصاديات دورة الوقود", "مقارنة تقنيات الفصل بمعيار واحد", "تسعير SWU"],
  sources=["Benedict-Pigford", "Lamarsh", "Choppin"],
  tags=["مفتاح", "جديد 2026-09"])

N("fuel.enrichment_systems", "منظومات التخصيب: أنظمة وضمانات (مستوى أنظمة)",
  "Enrichment systems: systems level & safeguards",
  "fuel", 7, "supporting", 4, 25,
  prereqs=["fuel.separation", "fuel.fabrication", "sec.nonprolif"],
  concepts=["معماريات الشلال وأنماط الترابط (نظرياً وعلى مستوى الأنظمة)",
            "محاسبية المواد ونقاط القياس الرئيسية (KMP)",
            "الضمانات: الاحتواء والمراقبة، الختم، أخذ العينات، تحليل البيئة",
            "اقتصاديات المنشأة: رأس المال مقابل الطاقة مقابل الشغل",
            "حدود المعرفة المفتوحة في هذا المبحث (MAP/18)"],
  apps=["تحليل أنظمة دورة الوقود", "قراءة تقارير الضمانات", "دراسات عدم الانتشار"],
  sources=["IAEA-SSG-27", "WorldNuclear", "SIPRI"],
  tags=["مفتاح", "جديد 2026-09"])
