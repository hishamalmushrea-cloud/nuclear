...
N("safe.criticality", "سلامة الحرجة في التعامل مع المواد الانشطارية", "Criticality safety (fissile material handling)",
  "safe", 6, "core", 4, 35,
  prereqs=["rx.criticality", "safe.hazard", "math.stat"],
  concepts=["k_eff وهامش تحت-الحرج: التحيز وعدم اليقين من التحقق التجريبي",
            "مبدأ الطوارئ المزدوجة (Double Contingency)",
            "الحدود الستة: كتلة، حجم، هندسة، تركيز، كثافة مساحية، تباعد/انعكاس",
            "التهدئة والانعكاس والتفاعل بين الوحدات",
            "منهجية التحقق: تجارب حرجة معيارية قبل قبول الكود",
            "دروس الحوادث: توكايمورا 1999، وود ريفر 1964، لوس ألاموس 1945–46"],
  eqs=["k_eff = k_∞ / [(1 + L²B²)(1 + τB²)]",
       "B² = (π/a)² للوح   ,   B² = (2.405/R)² للأسطوانة",
       "هامش الأمان = 1 − (k_eff_محسوب + تحيز + عدم يقين)"],
  apps=["منشآت الوقود والتحويل والتصنيع", "المختبرات التي تتعامل مع مواد انشطارية",
        "النقل والتخزين", "التفكيك وإزالة التخصيص"],
  sources=["IAEA-SSG-27", "ANSI-ANS-8.1", "LA-13638", "Duderstadt"],
  tags=["مفتاح", "سلامة", "جديد 2026-09"])
